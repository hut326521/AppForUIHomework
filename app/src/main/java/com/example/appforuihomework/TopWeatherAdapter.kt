...
class TopWeatherAdapter(private var context: Context, private var list: List<WeatherData>): RecyclerView.Adapter<TopWeatherAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(
        ...
        return ViewHolder(
            DataBindingUtil.inflate(
                ...
                R.layout.top_item_recycler, parent, false
            )
        )
    }
